...
<section class="comp-section">
    ...
    <p>
        Cette compétence a été appliquée sur plusieurs projets significatifs et au cours de mes expériences 
        professionnelles, comme détaillé ci-dessous.
        J'ai utilisé Fyne, un toolkit UI multiplateforme Go, pour construire l'intégralité de l'interface utilisateur de l'application de 
