...
<section class="comp-section">
    ...
    <p>
        <strong>Gestion quotidienne et optimisation de l'environnement de développement (<a class="link" href="/projets/detail.html?id=1">Escarcelle</a>, <a class="link" href="/projets/detail.html?id=6">PMT</a>, <a class="link" href="/projets/detail.html?id=2">Caisse</a>).</strong>
