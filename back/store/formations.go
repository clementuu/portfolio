...
var (
	...
	licence = model.Formation{ID: 2, Intitule: "Licence Mathématiques et Informatique appliquées aux SHS", Etablissement: "Paul Valéry Montpellier 3", Periode: "2019 - 2022", Logo: constants.PaulVaLogo, Presentation: tmpl.PaulVaPresentation, URL: "https://www.univ-montp3.fr"}
