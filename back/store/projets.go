...
var (
	...
	projetPMT        = model.Projet{ID: 6, Name: "PMT", Sujet: "Gestion de projet collaboratif", Image: constants.PMTLogo, Competences: []model.Competence{springCompetence, angularCompetence, sqlCompetence, dockerCompetence, espritCritiqueCompetence, creativiteCompetence}, Resume: constants.ResumPMT, Template: tmpl.PmtHTML}
)
