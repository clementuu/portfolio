...
var (
	projetEscarcelle = model.Projet{ID: 1, Name: "Escarcelle", Sujet: "Gestion d'épicerie solidaire", Image: constants.EscarcelleLogo, Competences: []model.Competence{goCompetence, rebolCompetence, svelteCompetence, sqlCompetence, bashCompetence, dockerCompetence, gestionProjetCompetence, flexibiliteCompetence}, Resume: constants.ResumEscarcelle, Template: tmpl.EscarcelleHTML}
	projetCaisse     = model.Projet{ID: 2, Name: "Caisse", Sujet: "Refonte de la caisse Escarcelle", Image: constants.CaisseLogo, Competences: []model.Competence{goCompetence, sqlCompetence, dockerCompetence, gestionProjetCompetence, creativiteCompetence, flexibiliteCompetence, espritCritiqueCompetence}, Resume: constants.ResumCaisse, Template: tmpl.CaisseHTML}
	...
	projetPMT        = model.Projet{ID: 5, Name: "PMT", Sujet: "Gestion de projet collaboratif", Image: constants.PMTLogo, Competences: []model.Competence{springCompetence, angularCompetence, sqlCompetence, dockerCompetence, espritCritiqueCompetence, creativiteCompetence}, Resume: constants.ResumPMT, Template: tmpl.PmtHTML}
)
