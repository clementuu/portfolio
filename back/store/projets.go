...
var (
	...
	projetPMT        = model.Projet{ID: 6, Name: "Project Management Tool", Sujet: "Gestion de projet collaboratif", Image: constants.PMTLogo, Competences: []model.Competence{springCompetence, javaCompetence, angularCompetence, sqlCompetence, dockerCompetence, espritCritiqueCompetence, creativiteCompetence}, Resume: constants.ResumPMT, Template: tmpl.PmtHTML}
)
