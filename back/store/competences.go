...
var (
	...
	rCompetence              = model.Competence{ID: 11, Name: "R", Image: constants.RLogo, Rating: 2, Template: tmpl.RCompetence, Type: model.Dev}
	dockerCompetence         = model.Competence{ID: 12, Name: "Docker", Image: constants.DockerLogo, Rating: 4, Template: tmpl.DockerCompetence, Type: model.DevOps}
	bashCompetence           = model.Competence{ID: 13, Name: "Bash", Image: constants.BashLogo, Rating: 2, Template: tmpl.BashCompetence, Type: model.DevOps}
