...
var (
	...
	JavaScriptCompetence     = model.Competence{ID: 4, Name: "JavaScript", Image: constants.JsLogo, Rating: 3, Template: tmpl.JavaScriptComp, Type: model.Dev}
	...
	TypeScriptCompetence     = model.Competence{ID: 6, Name: "TypeScript", Image: constants.TScriptLogo, Rating: 2, Template: tmpl.TypeScriptComp, Type: model.Dev}
	AngularCompetence        = model.Competence{ID: 7, Name: "Angular", Image: constants.AngularLogo, Rating: 2, Template: tmpl.AngularComp, Type: model.Dev}
	SQLCompetence            = model.Competence{ID: 8, Name: "SQL", Image: constants.SqlLogo, Rating: 4, Template: tmpl.SQLComp, Type: model.Dev}
	JavaCompetence           = model.Competence{ID: 9, Name: "Java", Image: constants.JavaLogo, Rating: 2, Template: tmpl.JavaComp, Type: model.Dev}
	SpringCompetence         = model.Competence{ID: 10, Name: "Spring", Image: constants.SpringLogo, Rating: 3, Template: tmpl.SpringComp, Type: model.Dev}
	PythonCompetence         = model.Competence{ID: 11, Name: "Python", Image: constants.PythonLogo, Rating: 3, Template: tmpl.PythonComp, Type: model.Dev}
	RebolCompetence          = model.Competence{ID: 14, Name: "Rebol", Image: constants.RebolLogo, Rating: 2, Template: tmpl.RebolComp, Type: model.Dev}
	RCompetence              = model.Competence{ID: 15, Name: "R", Image: constants.RLogo, Rating: 2, Template: tmpl.RComp, Type: model.Dev}
	...
	BashCompetence           = model.Competence{ID: 18, Name: "Bash", Image: constants.BashLogo, Rating: 2, Template: tmpl.BashComp, Type: model.DevOps}
	...
	FlexibiliteCompetence    = model.Competence{ID: 21, Name: "Flexibilité", Image: constants.FlexLogo, Rating: 4, Template: tmpl.FlexibiliteComp, Type: model.Human}
