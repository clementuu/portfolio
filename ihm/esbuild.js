...
let commonOptions = {
	entryPoints: ['./App.svelte', './about.svelte', './projets/projets.svelte', './projets/detail.svelte', './competences/competences.svelte', './competences/detail.svelte', './contacts.svelte', './blog/blog.svelte', './blog/detail.svelte'],
	bundle: true,
	format: 'esm',
	plugins: [
		sveltePlugin({
