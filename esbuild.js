...
let commonOptions = {
	entryPoints: ['./ihm/app.svelte','./ihm/header.svelte','./ihm/projets/projets.svelte','./ihm/competences/competences.svelte','./ihm/competences/detail.svelte','./ihm/contacts.svelte'],
	bundle: true,
	format: 'esm',
	plugins: [
		sveltePlugin({
